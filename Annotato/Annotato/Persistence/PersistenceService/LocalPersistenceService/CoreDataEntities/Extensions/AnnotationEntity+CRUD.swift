...
extension AnnotationEntity {
    func customUpdate(usingUpdatedModel annotation: Annotation) {
        ...
        for annotationText in annotationTexts {
            if let annotationTextEntity = Self.localAnnotationTextEntityDataAccess
        ...
        for annotationHandwriting in annotationHandwritings {
            if let annotationHandwritingEntity = Self.localAnnotationHandwritingEntityDataAccess
        ...
        if let selectionBoxEntity = Self.localSelectionBoxEntityDataAccess
